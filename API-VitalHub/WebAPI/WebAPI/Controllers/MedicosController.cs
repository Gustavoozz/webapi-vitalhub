...
namespace WebAPI.Controllers
{
    ...
    public class MedicosController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromForm] MedicoViewModel medicoModel)
        {
            ...
            var containerName = "containervitalhubg8";
            ...
            user.Foto = await AzureBlobStorageHelper.UploadImageBlobAsync(medicoModel.Arquivo!, connectionString, containerName); user.Senha = medicoModel.Senha;
